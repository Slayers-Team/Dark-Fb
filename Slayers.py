#decompiled by Slayers
import os, sys
print '\x1b[1;32mSelamat Datang,Untuk ID Dan PASSWORD Chat Admin aja dan jangan lupa login facebook di OperaMini dulu sebelum login agar tidak CekPoint'
print '\x1b[1;32mSlayers Team '
import os, sys

def wa():
    os.system('xdg-open https://api.whatsapp.com/send?phone=+6283198371396&text=Slayers Minta ID Sama Password!')
...
if sandi == 'SlayersTeam' and user == '2840017992353095':
    print 'ID DAN PASSWORD BENAR!'
    sys.exit
else:
...
def login():
    ...
    try:
        ...
        id = raw_input('\x1b[1;91m[+] \x1b[1;36mEmail/Phonsel \x1b[1;91m:\x1b[1;92m ')
        ...
        if 'checkpoint' in url:
            print '\n\x1b[1;91m[!] \x1b[1;93mAkun Kamu Kena Sesi (checkpoint)'
